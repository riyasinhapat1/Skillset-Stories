...
use Elementor\Utils;
use ElementorPro\Modules\ConversionCenter\Classes\Render\Icons_Below_Cta_Render;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly
}

class Link_In_Bio_Var_4 extends Widget_Link_In_Bio_Base {
	...
	public function get_title(): string {
		return esc_html__( 'Link In Bio Variation 4', 'elementor-pro' );
	}
